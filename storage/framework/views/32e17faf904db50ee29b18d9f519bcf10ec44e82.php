...
<body>
    <input type="hidden" id="billing" name="billing" value="<?php echo e($userinfo->billing); ?>">                                                                
        ...
        <div class="rr-content">
            ...
            <div class="pricing-content-wrapper">
                ...
                <div style="padding: 10px 0 10px 0px; float: left; width: 100%; text-align: center;"> 
                    ...
                    <div class="pricing-pop-brandtxt notify-downgrade">You will get <b style="color : #0071ff"><?php echo e($userinfo->down_plan_name); ?></b> plan from <?php echo e($userinfo->down_date); ?></div>
                    <?php endif; ?>
                    ...
                    <div id="disableDowngrade" class="pricing-pop-brandtxt" style="color:#f00;display:none">You have already downgraded plan at <?php echo e(date("Y-m-d",strtotime($userinfo->last_downgrade))); ?></br>Please wait until next month to downgrade plan</div>
                                            ...
                                            <div class="box-bordered-content">
                                                ...
                                                <div class="features-highlight-list">
                                                    <ul>
                                                        <li>
                                                            <p class="avail month-feature">
                                                                <span style="font-weight: 600 !important;">1500</span>
                                                                <span class="desktop-none">&nbsp;credits&nbsp;</span>
                                                                per month
                                                            </p>
                                                            <p class="avail year-feature" style="display:none">
