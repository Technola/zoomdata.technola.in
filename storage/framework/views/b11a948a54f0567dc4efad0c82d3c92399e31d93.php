          ...
          <div class="row">
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <h3><?php echo e($school_count); ?></h3>
                  <p>Total Advisors</p>
                </div>
                <div class="icon">
                  <i class="ion ion-bag"></i>
                </div>
                <a href="<?php echo e(url(config('laraadmin.adminRoute').'/organizations')); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
