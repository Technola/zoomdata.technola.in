...
<head>
    ...
    <!--<link href="<?php echo e(asset('new-assets/css/homepage/css')); ?>" rel="stylesheet" type="text/css" media="all"> -->
...
<body>
    ...
    <div class="header">
        <div class="logo">
            <img src="<?php echo e(asset('new-assets/images/homepage/logo.png')); ?>" class="image-logo"/>
        </div>
    ...
    <div class="section1">
        <div class="overlay">
            <img src="<?php echo e(asset('new-assets/images/homepage/back_section1.png')); ?>" style="overlay-image"/>
        </div>
        <div class="container">
            ...
            <div class="section1-content">
                <div class="section1-button-container">
                    ...
                    <a href="" class="trial-button"><img src="<?php echo e(asset('new-assets/images/homepage/play.png')); ?>" class="play-image"/> WATCH VIDEO</a>
                </div>
                <div class="mini-filterpage">
                    <img src="<?php echo e(asset('new-assets/images/homepage/mini_filter.png')); ?>" class="mini-filterpage-image"/>
                </div>
            </div>
            <div class="text"></div>
        </div>
