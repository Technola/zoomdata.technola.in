    ...
    <div class="content">
        ...
        <div style="display:flex;padding-bottom:10px;">
            <div class="user-select">
                <select class="user-lists" id="userSelect">
                    ...
                    <?php if($userinfo->id == $user->id): ?>
                    <option id="user<?php echo e($user->id); ?>" selected><?php echo e($user->name); ?> (<?php echo e($user->cname); ?>)</option>
                    <?php else: ?>
                    <option id="user<?php echo e($user->id); ?>"><?php echo e($user->name); ?> (<?php echo e($user->cname); ?>)</option>
                    <?php endif; ?>
                    <?php endforeach; ?>
                </select>
            </div>
        ...
        <div class="tab-content">
            <div id="menu_summary" class="tab-pane fade in active">
                <div class="summary-heading">#<?php echo e($userinfo->id); ?> - <?php echo e($userinfo->name); ?></div>
                        ...
                        <div class="client-info-section">
                            ...
                            <div class="client-info-container">
                                ...
                                <div class="value-container">
                                    <div id="client_fname" class="value-item-0"><?php echo e($userinfo->fname); ?></div>
                                    <div id="client_lname" class="value-item-1"><?php echo e($userinfo->lname); ?></div>
                                    <div id="client_cname" class="value-item-0"><?php echo e($userinfo->cname); ?></div>
                                    <div id="client_email" class="value-item-1"><?php echo e($userinfo->email); ?></div>
                                    <div id="client_phone" class="value-item-0"><?php echo e($userinfo->phone); ?></div>
                                    <div id="client_cntry" class="value-item-1"><?php echo e($userinfo->cntry); ?></div>
                                    <div id="client_type" class="value-item-0"><?php echo e($userinfo->type); ?></div>
                                </div>
                            </div>
                            <div class="client-info-function">
                                <div class="function-row" data-toggle="modal" data-target="#customerEditModal" id="customerEdit"><image class="function-image" src="<?php echo e(asset('new-assets/images/icon/customer-edit.png')); ?>" width="20px" height="20px">Edit Customer</div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <input class="form-control" type="hidden" name="id" value="<?php echo e($userinfo->id); ?>">
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <div id="customerDelete" class="function-row"><image class="function-image" src="<?php echo e(asset('new-assets/images/icon/customer-delete.png')); ?>" width="20px" height="20px">Delete Customer</div>
                                <div data-toggle="modal" data-target="#customerPassChangeModal" id="customerPassChange" class="function-row"><image class="function-image" src="<?php echo e(asset('new-assets/images/icon/customer-password.png')); ?>" width="20px" height="20px">Change Password</div>
                                ...
                                <!-- end customerEditModal -->
                                <div class="function-row"><a style="color:unset" href="/frontlogin"><image class="function-image" src="<?php echo e(asset('new-assets/images/icon/customer-login.png')); ?>" width="20px" height="20px">Login as customer</a></div>
                    ...
                    <div class="center-section">
                        <div class="billing-section">
                            ...
                            <div class="billing-container">
                                ...
                                <div class="value-container">
                                    <div id="billing_paid" class="value-item-0"><?php echo e($userinfo->paid_count); ?> ($ <?php echo e($userinfo->paid_amount); ?>)</div>
                                    <div id="billing_draft" class="value-item-1"><?php echo e($userinfo->draft_count); ?> ($ <?php echo e($userinfo->draft_amount); ?>)</div>
                                    <div id="billing_due" class="value-item-0"><?php echo e($userinfo->unpaid_count); ?> ($ <?php echo e($userinfo->unpaid_amount); ?>)</div>
                                    <div id="billing_cancelled" class="value-item-1"><?php echo e($userinfo->cancelled_count); ?> ($ <?php echo e($userinfo->cancelled_amount); ?>)</div>
                                    <div id="billing_refunded" class="value-item-0"><?php echo e($userinfo->refunded_count); ?> ($ <?php echo e($userinfo->refunded_amount); ?>)</div>
                                    <div id="billing_plan" class="value-item-1"><?php echo e($userinfo->plan_name); ?></div>
                                    <div id="billing_billing" class="value-item-0">$<?php echo e($userinfo->billing_amount); ?>/<?php echo e($userinfo->billing_method); ?> <?php echo e($userinfo->billing_getcredit); ?></div>
                                    <div id="billing_credit" class="value-item-1"><?php echo e($userinfo->credit); ?></div>
                                </div>
                            </div>
                            <div class="billing-function">
                                <div id="changePlan" data-toggle="modal" data-target="#changePlanModal" class="function-row"><image class="function-image" src="<?php echo e(asset('new-assets/images/icon/plan-change.png')); ?>" width="20px" height="20px">Change Plan</div>   
                        ...
                        <div class="restriction-section">
                            ...
                            <div class="restriction-container">
                                ...
                                <div class="value-container">
                                    ...
                                    <div class="value-item-0">
                                        <?php if($userinfo->view_contact == 1): ?>
                                            <div class="txt-green">ON</div>
                                        <?php endif; ?>
                                        <?php if($userinfo->view_contact == 0): ?>
                                            <div class="txt-red">OFF</div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="value-item-1">
                                        <?php if($userinfo->upgrade_plan == 1): ?>
                                            <div class="txt-green">ON</div>
                                        <?php endif; ?>
                                        <?php if($userinfo->upgrade_plan == 0): ?>
                                            <div class="txt-red">OFF</div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="value-item-0">
                                        <?php if($userinfo->downgrade_plan == 1): ?>
                                            <div class="txt-green">ON</div>
                                        <?php endif; ?>
                                        <?php if($userinfo->downgrade_plan == 0): ?>
                                            <div class="txt-red">OFF</div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="value-item-1">
                                        <?php if($userinfo->cancel_plan == 1): ?>
                                            <div class="txt-green">ON</div>
                                        <?php endif; ?>
                                        <?php if($userinfo->cancel_plan == 0): ?>
                                            <div class="txt-red">OFF</div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="value-item-0">
                                        <?php if($userinfo->download_contact == 1): ?>
                                            <div class="txt-green">ON</div>
                                        <?php endif; ?>
                                        <?php if($userinfo->download_contact == 0): ?>
                                            <div class="txt-red">OFF</div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <div class="restriction-function">
                                <div data-toggle="modal" data-target="#changeRestrictionModal" class="function-row"><image class="function-image" src="<?php echo e(asset('new-assets/images/icon/restriction-change.png')); ?>" width="20px" height="20px">Change Restriction</div>   
                        ...
                        <div class="recent-action-section">
                            ...
                            <div class="recent-action-container">
                                <?php if($recentActions): ?>
                                    ...
                                    <?php foreach($recentActions as $key=>$action): ?>
                                        <div class="key-item-<?php echo e($key % 2); ?>"><?php echo e(date( "Y-m-d h:m:s", strtotime($action->created_at))); ?></div>
                                        <?php if($key > 15): ?>
                                            <?php break; ?>;
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                    ...
                                    <?php foreach($recentActions as $key=>$action): ?>
                                        <div id="action<?php echo e($key); ?>" class="value-item-<?php echo e($key%2); ?>"><?php echo e(substr($action->description,0,10).'...'); ?>
                            ...
                            <div class="action-function">
                                <div id="viewAllActions" class="function-row"><image class="function-image" src="<?php echo e(asset('new-assets/images/icon/actions-viewall.png')); ?>" width="20px" height="20px">View all actions</div>   
                            </div>
                        </div>
                    </div>
                    <style>
            ...
            <h3>Log</h3>
            <?php foreach($recentActions as $key=>$action): ?>
                <p><?php echo e(date( "Y-m-d h:m:s", strtotime($action->created_at))); ?>         <?php echo e($action->description); ?></p>
            <?php endforeach; ?>
            </div>
        </div>
    </div>
...
$(document).on('show.bs.modal', '#customerEditModal', function (e) {
    ...
    $("#edit_fname").val('<?php echo e($userinfo->fname); ?>');
    $("#edit_lname").val('<?php echo e($userinfo->lname); ?>');
    $("#edit_email").val('<?php echo e($userinfo->email); ?>');
    $("#edit_cname").val('<?php echo e($userinfo->cname); ?>');
    $("#edit_phone").val('<?php echo e($userinfo->phone); ?>');
    $("#edit_cntry > [value="+'<?php echo e($userinfo->cntry); ?>'+"]").attr('selected',true);
    $("#select2-edit_cntry-container").html('<?php echo e($userinfo->cntry); ?>');
})
...
$(document).on('show.bs.modal', '#changePlanModal', function (e) {
    ...
    var plan = '<?php echo e(strtolower($userinfo->plan_name)); ?>';
    console.log(plan);
    var billing = '<?php echo e(chop($userinfo->billing_method,'ly')); ?>';
    console.log(billing);
...
function SendMessage(msg){
    var userid = <?php echo e($userinfo->id); ?>;
    var csrftoken  ='<?php echo e(csrf_token()); ?>';
    $.ajax({
        headers: {
            'X-CSRF-TOKEN': csrftoken
