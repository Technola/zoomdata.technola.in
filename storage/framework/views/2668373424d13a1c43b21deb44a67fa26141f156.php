    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div style="display: flex; justify-content: space-between">
                <div>
                    <div style="font-weight: bold; font-size: 20; margin-bottom: 3px;"><?php echo e($contracts[0]-> company_name); ?></div>
                    <a href="<?php echo e($contracts[0]-> company_website); ?>"><div><?php echo e($contracts[0]-> company_website); ?></div></a>
                    <div class="normalFont" style="background-color: #f78713; padding: 8px; color: white; margin-top: 5px;"><?php echo e($contracts[0]-> phone_number); ?></div>
                </div>
                <div>
                    <div class="smallFont">Revenue</div>
                    <div class="normalFont"><?php echo e($contracts[0]-> revenue); ?></div>
                    <div class="sepa"></div>
                    <div class="smallFont"> Industry </div>
                    <div class="normalFont"><?php echo e($contracts[0]-> industries); ?></div>
                </div>
                <div>
                    <div class="smallFont">Employees</div>
                    <div class="normalFont"><?php echo e($contracts[0]-> employees); ?></div>
                    <div class="sepa"></div>
                    <div class="smallFont"> Location </div>
                    <div class="normalFont"><?php echo e($contracts[0]-> city); ?> <?php echo e($contracts[0]-> state); ?> <?php echo e($contracts[0]-> country); ?></div>
                </div>
                <div>
                    <div class="smallFont">Business Model</div>
                    <div class="normalFont"><?php echo e($contracts[0]-> business_model); ?></div>
                    <div class="sepa"></div>
                    <div class="smallFont"> Founded Year </div>
                    <div class="normalFont"><?php echo e($contracts[0]-> year_founded); ?> </div>
                </div>
            </div>
            <div class="dashline">
            </div>
        ...
        <div class="container">
            ...
            <?php foreach($contracts as $item): ?>
                <div class="card">
                    <div class="card-name"><?php echo e($item-> first_name); ?> <?php echo e($item-> last_name); ?></div>
                    <div class="card-job"><?php echo e($item-> job_title); ?></div>
                    <div class="card-email"><?php echo e($item-> email_address); ?></div>
                    <div style="display: flex; justify-content: space-between; margin-top: 5px;">
                        <div class="card-phone"><?php echo e($item-> direct_phone); ?></div>
                        <div class="greenButton" onClick="viewContact(<?php echo e($item-> id); ?>)">View Contact</div>
                    </div>
                </div>
            <?php endforeach; ?>
            </div>
...
{
    console.log("+++view+++",id);
    if(<?php echo e($userinfo->credit); ?> === 0) {
