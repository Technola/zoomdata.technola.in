...
<link rel="stylesheet" href="<?php echo e(url('public/build/css/intlTelInput.css')); ?>">
<link rel="stylesheet" href="<?php echo e(url('public/build/css/demo.css')); ?>">
<!-- The Modal -->
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <!-- <?php if(isset($error_verify_email) && $error_verify_email): ?>
        <li id="error_verify_email" class="" style="color: green;padding-bottom: 10px;">Please verify your email address.</li>
    <?php endif; ?> -->

    <form class="row form-box " name="loginForm"  accept-charset="UTF-8" role="form" action="<?php echo e(url('/verify_otp')); ?>" method="post">
            ...
            <div class="email-registration-inputs">
                <div class="form-group">
                    ...
                    <ul class="error-messages">
                        ...
                        <?php if(isset($error_fullname_both) && $error_fullname_both): ?>
			...
			<div class="rr-auth-box">
				<div class="signup-pending">
					...
					<div class="col-xs-12 col-sm-6 oauth-signup">
                        ...
                        <?php endif; ?>
						<form class="row form-box " name="loginForm"  accept-charset="UTF-8" role="form" action="<?php echo e(url('/dologin')); ?>" method="post">
							<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								...
								<div class="email-registration-inputs">
									<div class="form-group">
										...
										<ul class="error-messages">
                                            ...
                                            <?php if(isset($error_email_business_login) && $error_email_business_login): ?>
											<li style="" id="error_email_business_login">Business email address required.</li>
                                            <?php endif; ?>
                                            <?php if(isset($error_no_user) && $error_no_user): ?>
											<li style="" id="error_no_user">No user exists</li>
                                            <?php endif; ?>
                                            <?php if(isset($error_email_verify) && $error_email_verify): ?>
									...
									<div class="form-group password-wpr">
										...
										<ul class="error-messages">
                                            ...
                                            <?php if(isset($error_password_incorrect) && $error_password_incorrect): ?>
							...
							<div class="signup-disclaimer-box">
								<!-- forgot -->
								<a target="_self" href="<?php echo e(url('/forgot-password')); ?>">Forgot password?</a>
                    		</div>
							</fieldset>
							</form>
						</div>
							...
							<fieldset class="email-signup-container">
								<div class="email-registration-inputs">
									...
									<div class="form-group">
										...
										<ul class="error-messages">
                                        <?php if(isset($error_email_business) && $error_email_business): ?>
											<li id="error_email_business">Business email address required.</li>
                                        <?php endif; ?>
                                        <?php if(isset($error_email_valid) && $error_email_valid): ?>
											<li id="error_email_valid">Please enter a valid email.</li>
                                        <?php endif; ?>
                                        <?php if(isset($error_email_exist) && $error_email_exist): ?>
                                    ...
                                    <!-- <div class="form-group phone-wpr">
                                        ...
                                        <?php if(isset($error_phone_number_valid) && $error_phone_number_valid): ?>
									...
									<div class="form-group password-wpr">
										...
										<ul class="error-messages">
											<li style="display:none" id="error_password_require">Password is required.</li>                                            
                                        <?php if(isset($error_password_minimum) && $error_password_minimum): ?>
...
<script src="<?php echo e(url('public/build/js/intlTelInput.js')); ?>"></script>
  <script>
    ...
    window.intlTelInput(input, {
      ...
      displayNumber: true,
      utilsScript: "<?php echo e(url('public/build/js/utils.js')); ?>",
    });
  </script>