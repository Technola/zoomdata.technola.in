        ...
        <div class="account-my-profile">
            ...
            <div class="account-profile-wrap">
                <div class="account-profile-row">
                    ...
                    <div class="account-profile-right"><?php echo e($userinfo->email); ?></div>
                </div>
            
                <div class="account-profile-row">
                    <div class="account-profile-left">My First Name</div>
                    <div class="account-profile-right">
                        <input class="account-profile-input" value="<?php echo e($userinfo->fname); ?>" id="firstname"/>
                    </div>
                </div>
                ...
                <div class="account-profile-row">
                    ...
                    <div class="account-profile-right">
                        <input class="account-profile-input" value="<?php echo e($userinfo->lname); ?>" id="lastname"/>
                    </div>
                </div>

                <div class="account-profile-row">
                    <div class="account-profile-left">My User Type</div>
                    <div class="account-profile-right"><?php echo e($userinfo->type); ?></div>
                </div>
                ...
                <div class="account-profile-row">
                    ...
                    <div class="account-profile-right">
                        <input class="account-profile-input" value="<?php echo e($userinfo->phone); ?>" id="phone"/>
                    </div>
                </div>
