						...
						<form class="row form-box " name="loginForm"  accept-charset="UTF-8" role="form" action="<?php echo e(url('/verify_otp')); ?>" method="post">
							...
							<fieldset class="phone-signup-container">
								<div class="phone-registration-inputs">
                                    ...
                                    <?php if($data->verify_otp != 1): ?>
                                    <div class="form-group">
										<!-- phone -->
										<div class="peeky-placeholder-wrapper" is-invalid="false" required="required">
										<label for="phone" class="peeky-placeholder ">
										<input id="phone" name="phone" type="phone" ply-unique-phone-validator="" placeholder="Phone number" autocomplete="username" class="form-control" is-invalid="false" required="required" value="<?php echo e($data->phone); ?>" autofocus readonly="readonly"><span>Phone number</span></label>
										</div>
									</div>
...
$(document).ready(function(){
    ...
    $('.resend_email').on("click",function(){
        ...
        $.ajax({
			url : "<?php echo e(url('/resend_email')); ?>",
			type : 'POST',
			data : input,
			success : function(response) {
                // alert(response);
