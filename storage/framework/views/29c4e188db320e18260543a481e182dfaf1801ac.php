...
<head>  
    ...
    <script type="text/javascript" async="" src="<?php echo e(asset('new-assets/js/filterpage/f.txt')); ?>"></script>
    <script src="<?php echo e(asset('new-assets/js/filterpage/5640795.js')); ?>" type="text/javascript" id="hs-analytics"></script>
    <script src="<?php echo e(asset('new-assets/js/filterpage/5640795.js(1).download')); ?>" type="text/javascript" id="cookieBanner-5640795"
        data-loader="hs-scriptloader" data-hsjs-portal="5640795" data-hsjs-env="prod"></script>
    <script src="<?php echo e(asset('new-assets/js/filterpage/fb.js')); ?>" type="text/javascript" id="hs-ads-pixel-5640795"
    ...
    <script type="text/javascript" async="" src="<?php echo e(asset('new-assets/js/filterpage/34cee668imvp.js')); ?>"></script>
    <script type="text/javascript" async="" src="<?php echo e(asset('new-assets/js/filterpage/mixpanel-2-latest.min.js')); ?>"></script>
    <script type="text/javascript" async="" src="<?php echo e(asset('new-assets/js/filterpage/analytics.js')); ?>"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
    <script async="" src="<?php echo e(asset('new-assets/js/filterpage/gtm.js')); ?>"></script>
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <meta name="theme-color" content="#000000">
    <script src="<?php echo e(asset('new-assets/js/filterpage/checkout.js')); ?>"></script>

    <title>New Designed Filter Page</title>
    <link href="<?php echo e(asset('new-assets/css/filterpage/css')); ?>" rel="stylesheet">
    <style>
        @font-face {
    ...
    <link rel="stylesheet" href="<?php echo e(asset('new-assets/css/filterpage/font-awesome.css')); ?>">
    <script src="<?php echo e(asset('new-assets/js/filterpage/jquery.min.js')); ?>"></script>
    <link href="<?php echo e(asset('new-assets/css/filterpage/main.439c0ace.chunk.css')); ?>" rel="stylesheet">
    <script type="application/javascript" async="" src="<?php echo e(asset('new-assets/js/filterpage/2930.js')); ?>"></script>
    <script async="" src="<?php echo e(asset('new-assets/js/filterpage/js')); ?>"></script>
    <style>
        .header {
...
<header class="header">
    <div style="width: 20%">
        <a href="<?php echo e(url('/')); ?>" class="logo-link">
            <img style="height:60px" class="logo" src="<?php echo e(asset('new-assets/images/new/logo.jpg')); ?>" alt="Bookyourdata Email List Logo" width="112" height="100">
        </a>
    </div>
    <nav>
        <?php if(isset($allcontacts)): ?> 
        <div class="search-header">
            <div class="leads-count" style="display:none"><?php echo e($allcontacts); ?> Contacts</div>
        </div>
        <?php endif; ?>
        <div class="search-header">
            <div class="leads-count">Unused Credits <?php echo e($userinfo->credit); ?></div>
        </div>
        <ul>
            <li>
