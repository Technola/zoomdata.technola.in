                            ...
                            <zi-forgot-password _nghost-c13="">
                                <div _ngcontent-c13="" class="forgotPassword">
                                    ...
                                    <div _ngcontent-c13="" class="forgotPassword-sentEmail">
                                        ...
                                        <!-- <a _ngcontent-c13="" href="<?php echo e(url('/resetpassword')); ?>" class="forgotPasswordCta clickable" style="height: 60px;">Resend the Email</a> -->
                                            <form class="row form-box " action="<?php echo e(url('/resetpassword')); ?>" method="post" role="form">
                                    ...
                                    <zi-login-footer _ngcontent-c13="" _nghost-c14="">
                                        ...
                                        <a _ngcontent-c14="" href="<?php echo e(url('/frontlogin')); ?>" class="clickable-center footer-backBtn">Go back to login</a>
                                        </div>
                                    </zi-login-footer>
                                </div>
                            </zi-forgot-password>
