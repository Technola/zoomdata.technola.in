    ...
    <div class="main-content">
        ...
        <div class="slot-content">
            <section data-v-f9a0069e="" class="el-container is-vertical" element-loading-text="Loading">
                <!---->
                <?php if($userinfo->down_plan != -1): ?> 
                    <div class="notify-downgrade">You will get <b style="color : #3190c1"><?php echo e($userinfo->down_plan_name); ?></b> plan from <?php echo e($userinfo->down_date); ?></div>
                <?php endif; ?>
                <div data-v-f9a0069e="">
                    <!---->
                    <div data-v-f9a0069e="" class="plan-info">
                        <div data-v-f9a0069e="" class="plan-details">
                            ...
                            Current plan: 
                            <span data-v-f9a0069e="" class="value"><?php echo e($userinfo->productname); ?></span>
                            </div>
                            <div data-v-f9a0069e="" class="plan-item">
                        
                            Total available balance: 
                            <span data-v-f9a0069e="" class="value"><?php echo e($userinfo->credit); ?></span>
                            </div>
                        </div>
                    ...
                    <div data-v-f9a0069e="" class="subscriptions-cards">
                        ...
                        <?php echo e($userinfo->productname); ?> Plan
                        <!----></p>
                                <div data-v-6c79bc03="" class="card-item">
                                    <div data-v-6c79bc03="" class="card-title">Credits used</div
                                    ><div data-v-6c79bc03="" class="card-text"><?php echo e($userinfo->getcredit - $userinfo->credit < 0 ? 0 : $userinfo->getcredit - $userinfo->credit); ?> / <?php echo e($userinfo->getcredit); ?></div>
                                    <div data-v-6c79bc03="" role="progressbar" aria-valuenow="<?php echo e($userinfo->getcredit - $userinfo->credit < 0 ? 0 : $userinfo->getcredit - $userinfo->credit); ?> " aria-valuemin="0" aria-valuemax="<?php echo e($userinfo->getcredit); ?>" class="el-progress el-progress--line el-progress--without-text">
                                        <div class="el-progress-bar">
                                            <div class="el-progress-bar__outer" style="height: 5px;">
                                            <div class="el-progress-bar__inner" style="width: <?php echo e(($userinfo->getcredit - $userinfo->credit < 0 ? 0 : $userinfo->getcredit - $userinfo->credit) * 100 / $userinfo->getcredit); ?>%;"><!----></div>
                                        </div>
                                    </div>
                                    <!---->
                                </div>
                            ...
                            <div data-v-6c79bc03="" class="card-item">
                                ...
                                <div data-v-6c79bc03="" class="card-text"><?php echo e($userinfo->planstart); ?> - <?php echo e($userinfo->planend); ?></div>
                                ...
                                <div data-v-6c79bc03="" class="card-text">
                                    ...
                                    <span data-v-6c79bc03="" class="right-text">Will be renewed in <?php echo e($userinfo->leftdays); ?> days</span>
                                </div>
                                <!---->
                            </div>
                        </section>
