                    ...
                    <div class="rr-panel-top rr-checkout-header">
                        <h3 class="rr-panel__title">
                            <span class="rr-panel__title__medallion">
                                ...
                                <span class="plan-name"><?php echo e($paymethod); ?> Plan</span>
                            </span>
                                            ...
                                            <ul class="payment-info-selector">
                                                        ...
                                                        <div class="payment-info-panel__cc ng-scope">
                                                            <div class="billing-address-info billing-address-info--editable">
                                                                ...
                                                                <form method="post" action="/cardpay" id="billingForm" name="forms.billingAddressForm" novalidate="" class="billing-address-form">
                                                                    ...
                                                                    <input name="paymethod" id="paymethod" type="hidden" value=<?php echo e($paymethod); ?>>
                                                                    <input name="billing" id="billing" type="hidden" value=<?php echo e($billing); ?>>
                                                                    <input name="plan" id="plan" type="hidden" value=<?php echo e($plan); ?>>
                                                                    <?php if($customer == NULL) {?>
                                                                    <input name="customer" id="customer" type="hidden" value="">
                                                                    <?php }else {?>
                                                                    <input name="customer" id="customer" type="hidden" value=<?php echo e($customer); ?>>
                                                                    <?php }?>
                                                                    <fieldset>
                                                                        ...
                                                                        <div class="input-wrapper cardholder-info-input-wrapper">
                                                                            <label for="email"><span class="label-text">Email</span>
                                                                                <input id="email" name="email" type="text" maxlength="255" placeholder="Cardholder Email" required="required" style="" value=<?php echo e($email); ?>>
                                                                            </label>
                                                                            <label for="first-name"><span class="label-text">First Name</span>
                                                                            <input id="first-name" name="first_name" type="text" maxlength="255" placeholder="Cardholder First Name" class="left-half" required="required" style="" value=<?php echo e($firstname); ?>>
                                                                            </label>
                                                                            <label for="last-name"><span class="label-text">Last Name</span>
                                                                                <input id="last-name" name="last_name" type="text" maxlength="255" placeholder="Cardholder Last Name" class="right-half" required="required" style="" value=<?php echo e($lastname); ?>>
                                                                            </label>
                                                                        </div>
                                                ...
                                                <li id="paypalPopup" style="display:none">
                                                    <div class="paypal-wrapper">
                                                        <div>
                                                            <a href="/payment/<?php echo e($paymethod); ?>"><input type="button" class="paypal-button" value="Paypal"></a>
                                                        </div>
                                                        <div style="padding-top : 10px;"><span style="font-size:12px">The safer, the easier way to pay</span></div>
                                                        <div>
                                                            <ul class="card-list">
                                                                <li><img src="<?php echo e(asset('new-assets/images/new/payment-icons/pp-visa.svg')); ?>"></li>
                                                                <li><img src="<?php echo e(asset('new-assets/images/new/payment-icons/pp-mc.svg')); ?>"></li>
                                                                <li><img src="<?php echo e(asset('new-assets/images/new/payment-icons/pp-amex.svg')); ?>"></li>
                                                                <li><img src="<?php echo e(asset('new-assets/images/new/payment-icons/pp-discover.svg')); ?>"></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
                                ...
                                <div class="order-summary-box">
                                    <div class="order-summary-box__section order-summary-box__section--interval">
                                        <div class="order-summary-box__section--interval__left">
                                            Total <span class="order-summary-box__section--interval__left__value">$<?php echo e($amount); ?>
                                        ...
                                        <div class="order-summary-box__section--interval__right">
                                            <b>
                                            <?php if($billing == 'yearly') {?>
                                                <span>$<?php echo e($amount * 12); ?></span>
                                            <?php }else if($billing == 'monthly'){?>
                                    ...
                                    <div class="order-summary-box__section order-summary-box__section--details ng-scope">
                                        <?php if($billing == 'yearly') {?>
                                            <p>Your <?php echo e($paymethod); ?> subscription begins today and will renew on <b><?php echo e(date("Y-m-d", strtotime("+1 year", time()))); ?></b>.</p>
                                        <?php }else if($billing == 'monthly'){?>
                                            <p>Your <?php echo e($paymethod); ?> subscription begins today and will renew on <b><?php echo e(date("Y-m-d", strtotime("+1 month", time()))); ?></b>.</p>
                                        <?php }?>
                                        <p> Once your credit card payment has gone through you'll have access to <b><?php echo e($credits); ?></b> lookups per month<span>, where credits are allocated all upfront</span>.</span>
                                        </p>
                                    </div>
                                </div>
...
Stripe.setPublishableKey('pk_test_uPHbA4uj1n1d4UJB4xDTMSJ9');
