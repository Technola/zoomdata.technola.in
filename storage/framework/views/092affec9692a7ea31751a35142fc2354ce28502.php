<script src="<?php echo e(asset('la-assets/plugins/dropzone/dropzone.js')); ?>"></script>
<?php
				...
				<div class="row">
					<div class="col-xs-3 col-sm-3 col-md-3">
						<div class="fm_folder_selector">
							<form action="<?php echo e(url(config('laraadmin.adminRoute') . '/upload_files')); ?>" id="fm_dropzone" enctype="multipart/form-data" method="POST">
								<?php echo e(csrf_field()); ?>

								<div class="dz-message"><i class="fa fa-cloud-upload"></i><br>Drop files here to upload</div>
								
								<?php if(!config('laraadmin.uploads.private_uploads')): ?>
									<label class="fm_folder_title">Is Public ?</label>
									<?php echo e(Form::checkbox("public", "public", config("laraadmin.uploads.default_public"), [])); ?>
