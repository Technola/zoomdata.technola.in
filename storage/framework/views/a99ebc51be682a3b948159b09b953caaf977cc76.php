...
<div class="">
                        ...
                        <div class="save-search open-search" id="openSearch">
                            ...
                            <div class="save-suggestion-list animatedFast animatedDropDown hide-suggestion">
                                <div class="suggestion-list-wrap savedfilters">
                                    ...
                                    <?php endif; ?>
                                    <?php if(!empty($savedfilters)): ?>
                                    <?php foreach($savedfilters as $val): ?>
                                    <div class="suggestion-item" title="<?php echo e($val->filtername); ?>" data-name="<?php echo e($val->filtername); ?>">
                                        <div class="saved-item show-elipsis"><?php echo e($val->filtername); ?></div>
                        ...
                        <div class="filter-parents">
                            ...
                            <div class="dropdown-section " id="joblevel" style="display:none">
                                ...
                                <div class="suggestion-list animatedFast animatedDropDown hide-suggestion">
                                    ...
                                    <?php if(!empty($joblevel_array)): ?>
                                    <?php foreach($joblevel_array as $key=>$filter_jobf): ?>
                                        <div class="suggestion-item" data-name="<?php echo e($key); ?>">
                                            <div class="check-box">
                            ...
                            <div class="dropdown-section " id="jobtitle">
                                ...
                                <div class="suggestion-list animatedFast animatedDropDown hide-suggestion">
                                    ...
                                    <div class="suggestion-list-wrap">
                                        <?php if(!empty($function_array)): ?>
                                        <?php foreach($function_array as $key=>$filter_jobf): ?>
                                        <?php if(count($filter_jobf)>1): ?>
                                        <?php foreach($filter_jobf as $key1=>$filter_jobf1): ?>
                                        <div class="suggestion-item" data-name="<?php echo e($filter_jobf1); ?>" level-id="<?php echo e($key); ?>">
                                            <div class="check-box">
                                                <div class="common-check-box ">
                                                    <div class="common-check-box-content">
                                                        <div class="empty-check-box"></div>
                            ...
                            <div class="dropdown-section" id="industry">
                                ...
                                <div class="suggestion-list animatedFast animatedDropDown hide-suggestion">
                                    ...
                                    <div class="suggestion-list-wrap">
                                        <?php if(!empty($filter_indus)): ?>
                                        <?php foreach($filter_indus as $indus): ?>
                                        <div class="suggestion-item" data-name="<?php echo e($indus); ?>">
                                            <div class="check-box">
                                                <div class="common-check-box">
                                                    <div class="common-check-box-content">
                                                        <div class="empty-check-box"></div>
                            ...
                            <div class="dropdown-section " id="country">
                                ...
                                <div class="suggestion-list animatedFast animatedDropDown hide-suggestion">
                                    ...
                                    <div class="suggestion-list-wrap">
                                        <?php if(!empty($filter_contry)): ?>
                                        <?php foreach($filter_contry as $country): ?>
                                        <div class="suggestion-item" data-name="<?php echo e($country); ?>">
                                            <div class="check-box">
                                                <div class="common-check-box ">
                                                    <div class="common-check-box-content">
                                                        <div class="empty-check-box"></div>
                            ...
                            <div class="dropdown-section " id="state">
                                ...
                                <div class="suggestion-list animatedFast animatedDropDown hide-suggestion">
                                    ...
                                    <div class="suggestion-list-wrap">
                                        ...
                                        <?php foreach($filter_state as $stat=>$val): ?>
                                        <div class="suggestion-item" data-name="<?php echo e($val['code']); ?>">
                                            <div class="check-box">
                                                <div class="common-check-box ">
                                                    <div class="common-check-box-content">
                                                        <div class="empty-check-box"></div>
                                            ...
                                            </div><?php echo e($val['stateswithcode']); ?>
                            ...
                            <div class="dropdown-section " id="city">
                                ...
                                <div class="suggestion-list animatedFast animatedDropDown hide-suggestion">
                                    ...
                                    <div class="suggestion-list-wrap">
                                        ...
                                        <?php foreach($filter_city as $cities): ?>
                                        <div class="suggestion-item" data-name="<?php echo e($cities); ?>">
                                            <div class="check-box">
                                                <div class="common-check-box ">
                                                    <div class="common-check-box-content">
                                                        <div class="empty-check-box"></div>
                            ...
                            <div class="dropdown-section" id="businesstype">
                                ...
                                <div class="suggestion-list animatedFast animatedDropDown hide-suggestion">
                                    ...
                                    <div class="suggestion-list-wrap">
                                        <?php if(!empty($ownership_array)): ?>
                                        <?php foreach($ownership_array as $key=>$filter_ownership): ?>
                                        <div class="suggestion-item" data-name="<?php echo e($filter_ownership); ?>">
                                            <div class="check-box">
                                                <div class="common-check-box">
                                                    <div class="common-check-box-content">
                                                        <div class="empty-check-box"></div>
                                            ...
                                            </div><?php echo e($filter_ownership); ?>
                            ...
                            <div class="dropdown-section" id="businessmodel">
                                ...
                                <div class="suggestion-list animatedFast animatedDropDown hide-suggestion">
                                    ...
                                    <div class="suggestion-list-wrap">
                                        <?php if(!empty($business_array)): ?>
                                        <?php foreach($business_array as $key=>$filter_business): ?>
                                        <div class="suggestion-item" data-name="<?php echo e($filter_business); ?>">
                                            <div class="check-box">
                                                <div class="common-check-box">
                                                    <div class="common-check-box-content">
                                                        <div class="empty-check-box"></div>
                                            ...
                                            </div><?php echo e($filter_business); ?>
                            ...
                            <div class="dropdown-section" id="yearfounded">
                                ...
                                <div class="suggestion-list animatedFast animatedDropDown hide-suggestion">
                                    ...
                                    <div class="suggestion-list-wrap">
                                        <?php if(!empty($yearfounded_array)): ?>
                                        <?php foreach($yearfounded_array as $key=>$filter_yearfounded): ?>
                                        <div class="suggestion-item" data-name="<?php echo e($filter_yearfounded); ?>">
                                            <div class="check-box">
                                                <div class="common-check-box">
                                                    <div class="common-check-box-content">
                                                        <div class="empty-check-box"></div>
                                            ...
                                            </div><?php echo e($filter_yearfounded); ?>
                                ...
                                <div class="drop-popup-box animatedFast animatedDropDown">
                                    ...
                                    <div class="list-action-item range-selection">
                                        ...
                                        <div class="range-selection-box"><input id="rangeInputBox" min="1" step="1"
                                                max="<?php echo e($userinfo->credit); ?>" type="number" placeholder="upto <?php echo e($userinfo->credit); ?>" value=""><i
                        ...
                        <div class="contact-list-wrap">
                            ...
                            <div class="contact-item">
                                ...
                                <div class="contact-name">
                                    <div class="id item-id" style="display:none"><?php echo e($row->id); ?></div>
                                    <div class="name item-name"><?php echo e($row->first_name); ?> <?php echo e($row->last_name); ?></div>
                                    <div class="title item-title"><?php echo e($row->job_title); ?></div>
                                </div>
                                <div class="company-name">
                                    <div class="name item-cname"><?php echo e($row->company_name); ?></div>
                                    <div class="company-address-info"><?php echo e($row->city); ?>,<?php echo e($row->state); ?>,<?php echo e($row->country); ?></div>
                                </div>
                                <div class="email item-email"><?php echo e($row->email_address); ?></div>
                                <div class="phone-number">
                                    <div class="name item-dphone"><?php echo e($row->direct_phone); ?></div>
                                    <div class="name item-phone"><?php echo e($row->phone_number); ?></div>
                                </div>
    ...
    <input type="hidden" value="<?php echo e($userinfo->credit); ?>" id="userCredit">
</div>
<script>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for ( i = 0 ;i < result.length ;i++) {
                    ...
                    } else if(<?php echo e($userinfo->view_contact); ?> ==0 ) {
                        $(".contact-list-wrap").append('<div class="contact-item"><div class="contact-check-box-wrap"><div class="common-check-box"><div class="common-check-box-content"><div class="empty-check-box"></div><div class="common-check-box-svg-wrap"><svg width="16" height="14" viewBox="0 0 16 14"><path d="M2 8.5L6 12.5L14 1.5"></path></svg></div></div></div> </div><div class="contact-name"><div class="id item-id" style="display:none">'+result[i]['id']+'</div><div class="name item-name">'+result[i]['first_name']+' ' +result[i]['last_name'] + '</div><div class="title item-title">'+ result[i]['job_title'] + '</div> </div><div class="company-name"><div class="name item-cname">'+ result[i]['company_name']+'</div><div class="company-address-info">'+result[i]['city']+','+result[i]['state']+','+result[i]['country']+'</div></div> <div class="email item-email">'+result[i]['email_address']+'</div><div class="phone-number"><div class="name item-dphone">'+result[i]['direct_phone']+'</div><div class="name item-phone">'+result[i]['phone_number']+'</div> </div><div class="contact-action"><div class="contact-action-btn-wrap"></div></div> </div>');    
                    }
                }
