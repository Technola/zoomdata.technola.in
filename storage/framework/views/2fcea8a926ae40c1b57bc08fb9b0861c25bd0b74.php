			...
			<div class="rr-auth-box">
				<div class="signup-pending">
					...
					<div class="col-xs-12 col-sm-6 oauth-signup">
						<form class="row form-box " action="<?php echo e(url('/updatepassword/'.$token)); ?>" method="post" role="form">
							...
							<?php if($errors->has('new_password')): ?>
								<div class="errors"><?php echo e($errors->first('new_password')); ?></div>
							<?php endif; ?>
							<div class="form-group">
							...
							<?php if($errors->has('confirm_password')): ?>
								<div class="errors"><?php echo e($errors->first('confirm_password')); ?></div>
							<?php endif; ?>
