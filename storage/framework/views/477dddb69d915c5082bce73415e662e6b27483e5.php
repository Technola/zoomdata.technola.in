...
<div class="jmbtrn jmbtrn-regular jmbtrn-regular-bg">
        <div class="container jmbtrn-container">
            <div class="jmbtrn-inner">
                <div class="row">
                    <div class="col-md-5">
                        <h1 class="jmbtrn-title"><?php echo e($pricing->title); ?></h1>
                    ...
                    <div class="col-md-7">
                        <p><?php echo e($pricing->monthly_desp_one); ?><br>
                           <?php echo e($pricing->monthly_dep_two); ?></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 text-right-dnu">
                            <a class="button button-septenary button-small text-uppercase gap-bottom-small-tld full-width-pld"
                                href="<?php echo e(url('/ready-made-lists/job-levels')); ?>">By Job Level</a>
                            <a class="button button-septenary button-small text-uppercase gap-bottom-small-tld full-width-pld"
                                href="<?php echo e(url('/jobtitle')); ?>">By Job Title</a>
                            <a class="button button-septenary button-small text-uppercase gap-bottom-small-tld full-width-pld"
                                href="<?php echo e(url('/ready-made-lists/job-functions')); ?>">By Job Function</a>
                            <a class="button button-septenary button-small text-uppercase gap-bottom-small-tld full-width-pld"
                                href="<?php echo e(url('ready-made-lists/industries')); ?>">By Industry</a>
                            <a class="button button-septenary button-small text-uppercase gap-bottom-small-tld full-width-pld"
                                href="<?php echo e(url('ready-made-lists/internationals')); ?>">By Country</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="box box-info gap-bottom">
                    <div class="row">
                        ...
                        <div class="col-lg-7 text-right-dnu">
                            <a class="button button-septenary button-small text-uppercase gap-bottom-small-tld full-width-pld"
                                href="<?php echo e(url('tool/healthcare')); ?>">View Healthcare Professionals</a>
                        </div>
                    </div>
                </div>
                <div class="table-responsive">
            ...
            <div id="content3" class="tab-content fade pad-top-small ">
                <div class="box box-info gap-bottom">
                    <div class="row">
                        ...
                        <div class="col-lg-7 text-right-dnu">
                            <a class="button button-septenary button-small text-uppercase gap-bottom-small-tld full-width-pld"
                                href="<?php echo e(url('tool/real_estate')); ?>">View Real Estate Agents</a>
                        </div>
                    </div>
                </div>
                <div class="table-responsive">
