                                        ...
                                        <tr
                                            ...
                                            <td class="Table-cell Table-cell--align--left Table-cell--verticalAlign--top Table-cell--width--minimized Table-cell--wrap--noWrap ListViewItem-cell"
                                                style="height: 1px; min-width: 300px;"><a
                                                    ...
                                                    <div class="ListViewItem-cellContent Box-root Padding-all--8"><span
                                                            class="ListViewItem-text Text-color--dark Text-fontSize--14 Text-fontWeight--medium Text-lineHeight--20 Text-numericSpacing--proportional Text-typeface--base Text-wrap--wrap Text-display--inline"><?php echo e($customer->email); ?></span>
                                                    </div>
                                                </a></td>
                                            <td aria-hidden="true"
                                                ...
                                                style="height: 1px;"><a class="UnstyledLink ListViewItem-link"
                                                    href="/test/customers/cus_IU8eXPSmwEX4ux">
                                                    <div class="ListViewItem-cellContent Box-root Padding-all--8"><span
                                                            class="ListViewItem-text Text-color--disabled Text-fontSize--14 Text-fontWeight--regular Text-lineHeight--20 Text-numericSpacing--proportional Text-typeface--base Text-wrap--wrap Text-display--inline"><?php echo e($customer->descriptipn?$customer->description:'---'); ?></span>
                                                    </div>
                                                </a></td>
                                            <td class="Table-cell Table-cell--align--left Table-cell--verticalAlign--top Table-cell--width--minimized Table-cell--wrap--noWrap ListViewItem-cell"
                                                                ...
                                                                <div class="Box-root Flex-flex Flex-direction--row Flex-justifyContent--flexStart Flex-wrap--nowrap"
                                                                    ...
                                                                    <div class="Box-root Box-hideIfEmpty Margin-top--12 Margin-left--12"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <?php if($customer->sources->data[0]->brand == 'Visa'): ?>
                                                                            ...
                                                                            <?php endif; ?>
                                                                            <?php if($customer->sources->data[0]->brand == 'MasterCard'): ?>
                                                                            <svg class="SVGInline-svg SVGInline--cleaned-svg SVG-svg BrandIcon-svg BrandIcon--size--20-svg"
                                                                                height="20" width="20"
                                                                                viewBox="0 0 32 32"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                    ...
                                                                    <div class="Box-root Box-hideIfEmpty Margin-top--12 Margin-left--12"
                                                                        style="pointer-events: auto;"><span
                                                                            ...
                                                                            <?php echo e($customer->sources->data[0]->last4); ?></span></div>
                                                                </div>
                                                            </div>
                                                        </span></div>
                                                </a></td>
                                            <td model="[object Object]"
                                                ...
                                                style="height: 1px; min-width: 150px;"><a
                                                    ...
                                                    href="/test/customers/cus_IU8eXPSmwEX4ux">
                                                    <div class="ListViewItem-cellContent Box-root Padding-all--8"><span
                                                            class="ListViewItem-text Text-color--default Text-fontSize--14 Text-fontWeight--regular Text-lineHeight--20 Text-numericSpacing--proportional Text-typeface--base Text-wrap--wrap Text-display--inline"><span><?php echo e(date("Y-m-d H:i:s", $customer->created)); ?></span></span>
                                                    </div>
                                                </a></td>
                                        </tr>
                                        <?php endforeach; ?>
                                ...
                                <div
                                    ...
                                    <div><span
                                            class="Text-color--default Text-fontSize--14 Text-fontWeight--regular Text-lineHeight--20 Text-numericSpacing--proportional Text-typeface--base Text-wrap--wrap Text-display--inline"><span><span>About
                                                    <strong id="invoiceCount"><?php echo e($count); ?></strong>
