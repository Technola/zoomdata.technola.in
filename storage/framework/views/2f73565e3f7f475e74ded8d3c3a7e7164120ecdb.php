                        ...
                        <div class="leads-list-wrap">
                            <div class="leads-list-item selected">
                                <div class="leads-list-item-wrap">
                                    ...
                                    <div class="leads-item-count"><span><?php echo e($myleads_count); ?></span></div>
                                </div>
                            </div>
                    ...
                    <div class="pagination-parent-wrap">
                        <div class="pagination-wrap">
                            <div class="pagination-section"><span class="pagination-current-page">1</span>&nbsp;to&nbsp;<span class="pagination-current-end-page">
                                <?php if($myleads_count > 20): ?>
                                    20
                                <?php else: ?>
                                    <?php echo e($myleads_count); ?>

                                <?php endif; ?>
                            </span>&nbsp;of&nbsp;<span class="pagination-last-page"><?php echo e($myleads_count); ?></span><i
                    ...
                    <div class="contact-list-wrap">
                        ...
                        <div class="contact-item">
                            ...
                            <div class="contact-name">
                                <div class="name item-name"><?php echo e($row->contactinfo[0]->first_name); ?> <?php echo e($row->contactinfo[0]->last_name); ?></div>
                                <div class="title item-title"><?php echo e($row->contactinfo[0]->job_title); ?></div>
                            </div>
                            <div class="email item-email">
                                <div>E: <?php echo e($row->contactinfo[0]->email_address); ?></div>
                                <div>D: <?php echo e($row->contactinfo[0]->direct_phone); ?></div>
                                <div>C: <?php echo e($row->contactinfo[0]->phone_number); ?></div>
                            </div>
                            <div class="company">
                                <div class="name item-cname"><?php echo e($row->contactinfo[0]->company_name); ?></div>
                                <div> <?php echo e($row->contactinfo[0]->company_website); ?></div>
                            </div>
                            <div class="address">
                                <div class="address1 item-address"><?php echo e($row->contactinfo[0]->address1); ?> <?php echo e($row->contactinfo[0]->address2); ?></div>
                                <div class="address2 item-address2"><?php echo e($row->contactinfo[0]->city); ?> <?php echo e($row->contactinfo[0]->state); ?> <?php echo e($row->contactinfo[0]->zipcode); ?> <?php echo e($row->contactinfo[0]->country); ?></div>
                            </div>
                            <div class="industry item-industry"><?php echo e($row->contactinfo[0]->industries); ?></div>
                            <div>
                                <div class="employees item-employees">E: <?php echo e($row->contactinfo[0]->employees); ?></div>
                                <div class="revenue item-revenue">R: <?php echo e($row->contactinfo[0]->revenue); ?></div>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
