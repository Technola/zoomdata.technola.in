...
class AboutController extends Controller
{
    ...
    **/
    ...
    public function index(){
    	...
    	return View('about',['frontpages' => $this->frontpages,
    		'joblevel' => $joblevel,
    		'page' => 'About Us',
    ...
    public function contact(){
    	...
    	return View('contact',['frontpages' => $this->frontpages,
    		'contact' => $contact,
    		'page' => 'Contact Us',
    		'currentid' => $this->user_id,
    	]);
    ...
    public function gdpr_ready(){
    	...
    	return View('new.newgdrpready',['frontpages' => $this->frontpages,
    ...
    public function events(){
    	...
    	return View('new.events',['frontpages' => $this->frontpages,
    		'events' => $events,
    		'page' => 'Contact Us',
    		'currentid' => $this->user_id,
    	]);
    ...
    public function resource(){
    	...
    	return View('new.resource',['frontpages' => $this->frontpages,
    		'events' => $events,
    		'page' => 'Contact Us',
    		'currentid' => $this->user_id,
    	]);
    ...
    public function blog(){
        ...
        return View('new.blog',['frontpages' => $this->frontpages,
            'events' => $events,
            'page' => 'Contact Us',
            'currentid' => $this->user_id,
        ]);
    ...
    public function web_developer(){
        ...
        $bnr_img = DB::table('uploads')->where('id', $imgid)->get()[0]->name;
        $events->image = url('/').'/storage/uploads/'.$bnr_img;
         return View('new.webdevloper',['frontpages' => $this->frontpages,
            'events' => $events,
            'page' => 'Contact Us',
            'currentid' => $this->user_id,
        ]);
    ...
    public function key_account_manager(){
        ...
        return View('career.key_account_manager',['frontpages' => $this->frontpages,
            'joblevel' => $joblevel,
            'page' => 'About Us',
            'currentid' => $this->user_id,
        ]);
    ...
    public function database_administrator(){
        ...
        return View('career.administrator',['frontpages' => $this->frontpages,
            'joblevel' => $joblevel,
            'page' => 'About Us',
            'currentid' => $this->user_id,
        ]);
    ...
    public function customer_support(){
       // die('218');
        ...
        return View('career.support',['frontpages' => $this->frontpages,
            'joblevel' => $joblevel,
            'page' => 'About Us',
            'currentid' => $this->user_id,
        ]);
