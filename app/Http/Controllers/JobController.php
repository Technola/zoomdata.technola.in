...
class JobController extends Controller
{
    ...
    **/
    public function jobFunctionDetails($name = NULL){//die('352');
            $hiddenfileds=array();
            $characters = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
            $charactersLength = strlen($characters);
            $randomStringfirst = '';
    ...
    **/
    public function industriesDetails($name = NULL){//die('566');
    ...
    **/
    public function healthcareDetails($name = NULL){//die('456');
            $hiddenfileds=array();
            $characters = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
            $charactersLength = strlen($characters);
            $randomStringfirst = '';
