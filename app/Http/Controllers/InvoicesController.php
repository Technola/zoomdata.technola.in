...
class InvoicesController extends Controller{
    ...
    **/
    ...
    public function getNextInvoices(Request $request) {
        ...
        return response()->json(array( 'result' => true, 'invoices' => $invoices , 'isbefore'=>true, 'isafter'=>$after));die();
    }
    public function getPreviousInvoices(Request $request) {
        ...
        return response()->json(array( 'result' => true, 'invoices' => $invoices, 'isbefore'=>$before, 'isafter'=>true));die();
    }
